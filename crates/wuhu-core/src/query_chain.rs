...
//
// Lives in wuhu-core so tools can inspect their own position in the
// delegation tree via ToolCtx::chain. Engine re-exports this type without
// modification.
//
...
//   deep.child()                           // Err(DepthExceeded { max: 5 })
// ============================================================================
...
///
/// Available inside `Tool::call()` via `ctx.chain` — tools can inspect
/// their depth and remaining budget before spawning further sub-agents.
